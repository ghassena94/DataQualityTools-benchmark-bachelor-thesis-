...
* The following cleaning signals have to be provided for the new dataset:
	...
	- Clusters to run the OpenRefine method, generated by
	  `python3 scripts/generate_openrefine_clusters.py` against a running OpenRefine
	  instance; they are written to `datasets/<name>/clusters/`
